      ...
      <div className="relative mx-auto flex min-h-[100svh] w-full max-w-[1400px] flex-col px-5 pb-10 pt-6 sm:px-10 lg:px-14">
        ...
        >
          <div className="max-w-[18ch] sm:max-w-none">
            <p
              data-gsap="hero-line"
              className="mb-5 text-xs font-medium uppercase tracking-[0.22em] text-black/45"
            >
              WordPress security
            </p>
            ...
            <h1 className="font-sans text-[clamp(2.4rem,7.2vw,5.75rem)] font-bold leading-[0.95] tracking-[-0.035em] text-black">
              ...
              <span
                data-gsap="hero-line"
                className="relative mt-[0.08em] inline-block pr-2"
              >
                <span className="relative z-[1]">out of trouble</span>
                <span
          ...
          <div className="mt-14 grid max-w-3xl grid-cols-1 items-end gap-8 sm:mt-16 sm:grid-cols-[auto_1px_1fr] sm:gap-x-8 md:mt-20">
            ...
            <div data-gsap="hero-cta" className="relative min-w-0">
              <div className="flex items-start justify-between gap-6">
                <p className="max-w-[24rem] text-[0.95rem] leading-relaxed text-black/55">
                  Hardening, malware cleanup, updates, and monitoring for
                  WordPress sites — so you&apos;re not the next &ldquo;your site
                  was hacked&rdquo; email.
                </p>
