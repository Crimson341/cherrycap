...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Cherry Capital Web", url: siteConfig.url }],
  creator: "Cherry Capital Web",
  publisher: "Cherry Capital Web",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Cherry Capital Web - AI-Powered Business Tools",
      },
    ],
  },
